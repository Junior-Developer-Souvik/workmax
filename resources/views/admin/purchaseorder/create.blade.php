                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8"><p class="small m-0">{{ $settings->po_order_address }}</p></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small m-0"><strong>City :</strong></p></div>
                                        <div class="col-sm-8"><p class="small m-0">{{ $settings->po_order_city }}</p></div>
                                    </div>                                    
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small m-0"><strong>State :</strong></p></div>
                                        <div class="col-sm-8"><p class="small m-0">{{ $settings->po_order_state }} </p></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small m-0"><strong>Country :</strong></p></div>
                                        <div class="col-sm-8"><p class="small m-0">{{ $settings->po_order_country }} </p></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small m-0"><strong>Pincode :</strong></p></div>
                                        <div class="col-sm-8"><p class="small m-0">{{ $settings->po_order_pin }} </p></div>
                                    </div>
                                    <input type="hidden" name="address" value="{{ $settings->po_order_address }}">
                                    <input type="hidden" name="city" value="{{ $settings->po_order_city }}">
                                    <input type="hidden" name="state" value="{{ $settings->po_order_state }}">
                                    <input type="hidden" name="country" value="{{ $settings->po_order_country }}">
                                    <input type="hidden" name="pin" value="{{ $settings->po_order_pin }}">
                                </div>
                            </div>
                            @if (!empty($supplier_id))
                            <div class="col-sm-4">
