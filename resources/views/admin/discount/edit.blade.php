...
<section>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form id="myForm" action="{{ route('admin.discount.update',$id) }}" method="POST">
                @csrf        
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{ $data->voucher_no }}" name="voucher_no" readonly id="voucher_no" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="hidden" name="store_id" id="store_id" value="{{ $data->store_id }}">
                            <input type="text" name="user_name" value="{{ getSingleAttributeTable('stores',$data->store_id,'bussiness_name') }}"  class="form-control"  id="select_user_name"  readonly>                            
                    ...
                    <div class="col-sm-2">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="amount"  value="{{ old('amount') ?? $data->amount }}" pattern="^\d*(\.\d{0,2})?$"  maxlength="10" name="amount" class="form-control" onkeypress="validateNum(event)"  placeholder="Enter amount ... " autocomplete="off">
                ...
                <div class="row" id="noncash_sec"> 
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{ $data->chq_utr_no }}" name="chq_utr_no" class="form-control" maxlength="100">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <div id="bank_search">
                                <input type="text" id="" placeholder="Search Bank" name="bank_name" value="{{ $data->bank_name }}" onkeyup="getBankList(this.value);" class="form-control bank_name" maxlength="200">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="entry_date" id="entry_date" class="form-control" value="{{ $data->entry_date }}" max="{{ date('Y-m-d') }}">
                    ...
                    <div class="col-sm-9">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="narration" class="form-control" style="" id="" cols="1" rows="2" placeholder="Enter some text ... ">{{ $data->narration }}</textarea>
                        </div>
                    </div>                    
                </div>                
                <div class="row">
                    <div class="form-group">
                        ...
                        <button id="submitBtn" type="submit" class="btn btn-sm btn-success">Edit</button>
                    </div>
                </div>
            </form>
        </div> 
