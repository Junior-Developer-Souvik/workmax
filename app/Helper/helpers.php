...
function GetDrivingDistance($lat1, $lon1, $lat2, $lon2){
    ...
    $google_api_key = $settings? $settings->google_api_key : '0';
...
function updateProductSellPrice($price,$cost_price,$product_id){
    ...
    $product_sales_price_threshold_percentage = $settings? $settings->product_sales_price_threshold_percentage: '0';
