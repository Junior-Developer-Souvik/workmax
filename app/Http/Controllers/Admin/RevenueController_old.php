...

{
...

    {
        ...
        $start_date = isset($request->from_date)?$request->from_date.' 00:00:00':($first_sale && is_object($first_sale)? $first_sale->created_at : '0');
        ...
        $total_expense = DB::table('journal')->where('is_debit',1)->whereBetween('created_at', [$start_date, $to_date])->sum('transaction_amount');
